...
<head>
    ...
    <meta name="csrf-token" content="Ee0zZlblObSwDgCUZDE6nmYBtpomFOTvkF8mEKez">
    <title>{$user.school} - {$user.names}</title>

    <meta name="description" content="Some description for the page"/>
    <!-- Favicon icon -->

    <link rel="shortcut icon" href="https://www.boostedtechs.com/assets/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="https://www.boostedtechs.com/assets/images/apple-touch-icon.png">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="/dashboard" class="brand-logo">
            <img class="logo-abbr" src="https://boostedtechs.com/assets/images/logo-5.png"" alt="">
            <img class="logo-compact" src="https://boostedtechs.com/assets/images/logo-5.png" alt="">
            <img class="brand-title" src="https://boostedtechs.com/assets/images/logo-5.png" alt="">
                            ...
                            <ul class="contacts">
                                ...
                                <li class="active dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="https://gymove.dexignzone.com/laravel/demo/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
                    ...
                    <ul class="navbar-nav header-right">
                        <li class="nav-item">
                            <div class="input-group search-area d-xl-inline-flex d-none">
                                ...
                                <input type="text" class="form-control" placeholder="Search {$user.school} here">
                            </div>
                        </li>
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media mr-2">
                                                    <img alt="image" width="50" src="https://gymove.dexignzone.com/laravel/demo/images/avatar/1.jpg">
                                                </div>
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                <img src="/media/users/{$user.photo}" width="20" alt=""/>
                                <div class="header-info">
                                    <span class="text-black"><strong>{$user.names}</strong></span>
        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        {if $smarty.session.role == 1}
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">User Management</a>
                                <ul aria-expanded="false">
                                    <li><a href="/students/">Student List</a> </li>
                                    <li><a href="/students/add-student">Add student</a> </li>
                                    <li><a href="/staff">Staff List</a> </li>
                                    <li><a href="/staff/add-staff">Add student</a> </li>
                                </ul>
                            </li>
                        {/if}
                    </ul>
                ...
                {if $smarty.session.role == 1}
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            {if $smarty.session.role == 1}
                                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Result Management</a>
                                    <ul aria-expanded="false">
                                        <li><a href="/results/mark-sheet">Mark sheet</a> </li>
                                        <li><a href="/results/reports">Create reports</a> </li>
                                    </ul>
                                </li>
                            {/if}
                        </ul>
                            ...
                            {if $smarty.session.role == 1}
                                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">User Management</a>
                                    <ul aria-expanded="false">
                                        ...
                                        <li><a href="/classes/add-class">Add Class</a> </li>
                                        <li><a href="/classes/stream">Stream list</a></li>
                                        <li><a href="/classes/add-stream">Add stream</a></li>
                                        <li><a href="/classes/level">Levels</a></li>
                                        <li><a href="/classes/add-levels">Add levels</a></li>
                                    </ul>
                                </li>
                                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Houses</a>
                                    <ul aria-expanded="false">
                                        <li><a href="/classes/house-list">House list</a> </li>
                                        <li><a href="/classes/add-house">Add House</a> </li>
                                    </ul>
                                </li>
                            {/if}
                        </ul>
                            ...
                            {if $smarty.session.role == 1}
                                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Subjects</a>
                                    <ul aria-expanded="false">
                                        ...
                                        <li><a href="/subjects/add-subject">Add Class</a> </li>
                                    </ul>
                                </li>
                            {/if}
                        </ul>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-accordion">Accordion</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-alert">Alert</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-badge">Badge</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-button">Button</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-modal">Modal</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-button-group">Button Group</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-list-group">List Group</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-media-object">Media Object</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-card">Cards</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-carousel">Carousel</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-dropdown">Dropdown</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-popover">Popover</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-progressbar">Progressbar</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-tab">Tab</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-typography">Typography</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-pagination">Pagination</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/ui-grid">Grid</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/uc-select2">Select 2</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/uc-nestable">Nestedable</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/uc-noui-slider">Noui Slider</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/uc-sweetalert">Sweet Alert</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/uc-toastr">Toastr</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/map-jqvmap">Jqv Map</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/uc-lightgallery">Lightgallery</a></li>
                    </ul>
                </li>
                <li><a href="https://gymove.dexignzone.com/laravel/demo/widget-basic" class="ai-icon" aria-expanded="false">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/form-element">Form Elements</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/form-wizard">Wizard</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/form-editor-summernote">Summernote</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/form-pickers">Pickers</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/form-validation-jquery">Jquery Validate</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/table-bootstrap-basic">Bootstrap</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/table-datatable-basic">Datatable</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/page-register">Register</a></li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/page-login">Login</a></li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                            <ul aria-expanded="false">
                                <li><a href="https://gymove.dexignzone.com/laravel/demo/page-error-400">Error 400</a></li>
                                <li><a href="https://gymove.dexignzone.com/laravel/demo/page-error-403">Error 403</a></li>
                                <li><a href="https://gymove.dexignzone.com/laravel/demo/page-error-404">Error 404</a></li>
                                <li><a href="https://gymove.dexignzone.com/laravel/demo/page-error-500">Error 500</a></li>
                                <li><a href="https://gymove.dexignzone.com/laravel/demo/page-error-503">Error 503</a></li>
                            </ul>
                        </li>
                        <li><a href="https://gymove.dexignzone.com/laravel/demo/page-lock-screen">Lock Screen</a></li>
                    </ul>
                </li>
            </ul>
            <div class="copyright">
                <p> © 2022 All Rights Reserved</p>
                <p>Made with <span class="heart"></span> by Boosted Technologies LTD</p>
            </div>
        </div>
    </div>
    <!--**********************************
...
***********************************-->
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" target="_blank">Boosted Technologies LTD</a> 2022</p>
        </div>
    </div>
    <!--**********************************
        Footer end
